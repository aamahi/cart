            ...
            <div class="row">
                <div class="col-lg-4 col-md-4 col-4">
                    <div class="logo-small-device">
                        <a href="index.html"><img alt="" src="{{asset('asset/frontend/assets/img/logo/logo.png')}}"></a>
                    </div>
                </div>
                    ...
                    <div class="header-contact-menu-wrapper pl-45">
                        ...
                        <div class="menu-wrapper text-center">
                            <button class="menu-toggle">
                                <img class="s-open" alt="" src="{{asset('asset/frontend/assets/img/icon-img/menu.png')}}">
                                <img class="s-close" alt="" src="{{asset('asset/frontend/assets/img/icon-img/menu-close.png')}}">
                            </button>
                            <div class="main-menu">
                                <nav>
                                    <ul>
                                        ...
                                        <li><a href="shop.html">shop</a>
                                            <ul class="mega-menu">
                                                ...
                                                <li class="mega-menu-img">
                                                    <ul>
                                                        <li><a class="dot-none" href="shop.html"><img alt="" src="{{asset('asset/frontend/assets/img/banner/17.jpg')}}"></a></li>
                                                    </ul>
                                                </li>
                                            </ul>
                                        </li>
