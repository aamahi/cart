<div class="slider-area">
    <div class="slider-active owl-carousel">
        <div class="single-slider slider-1" style="background-image: url({{asset('asset/frontend/assets/img/slider/slider-bg.jpg')}})">
            <div class="container">
                <div class="slider-content slider-animated-1">
                    <div class="slider-img text-center">
                        <img class="animated" src="{{asset('asset/frontend/assets/img/slider/bike-1.png')}}" alt="slider images">
                    </div>
                    <div class="slider-text-img">
                        <h6 class="animated">BOOK YOUR BIKE INSTANTLY AND ENJOY DISCOUNT</h6>
                        <img class="animated" src="{{asset('asset/frontend/assets/img/icon-img/bike.png')}}" alt="slider images">
                    </div>
        ...
        <div class="single-slider slider-1" style="background-image: url({{asset('asset/frontend/assets/img/slider/slider-bg.jpg')}})">
            <div class="container">
                <div class="slider-content slider-animated-1">
                    <div class="slider-img text-center">
                        <img class="animated" src="{{asset('asset/frontend/assets/img/slider/bike-2.png')}}" alt="slider images">
                    </div>
                    <div class="slider-text-img">
                        <h6 class="animated">BOOK YOUR BIKE INSTANTLY AND ENJOY DISCOUNT</h6>
                        <img class="animated" src="{{asset('asset/frontend/assets/img/icon-img/bike.png')}}" alt="slider images">
